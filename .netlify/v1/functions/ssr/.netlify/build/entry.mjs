...
import { manifest } from './manifest_DUER4hm6.mjs';
...
const _page6 = () => import('./pages/garden.astro.mjs');
const _page7 = () => import('./pages/hypersensitive.astro.mjs');
...
const _page15 = () => import('./pages/webrings.astro.mjs');
const _page16 = () => import('./pages/_slug_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/education.astro", _page5],
    ["src/pages/garden.astro", _page6],
    ["src/pages/hypersensitive.astro", _page7],
    ["src/pages/now.astro", _page8],
    ["src/pages/posts/[slug].astro", _page9],
    ["src/pages/research.astro", _page10],
    ...
    ["src/pages/webrings.astro", _page15],
...
const _args = {
    "middlewareSecret": "f7d8c0cf-3645-4d43-aa6d-f401cfdfbc8e"
};
